...
from app.models import ProductCreate, ProductUpdate, CategoryCreate, ProductSearchFilters
from app.database import (
    products_db, categories_db, product_id_counter, category_id_counter,
    get_product_by_id, get_category_by_id, search_products
)
